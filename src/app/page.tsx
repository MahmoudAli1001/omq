            ...
            <div>
                ...
                <div className="grow pt-0.5 pb-8 sm:pb-12">
                  <p className="text-sm lg:text-base text-neutral-400 font-cairo">
                    <span className="text-black font-semibold">
                      {language === 'ar' ? 'الخبرة التقنية المتقدمة:' : 'Advanced Technical Expertise:'}
                    </span>
                    {" "}
                    {language === 'ar' 
              ...
              <div className="flex gap-x-5 ms-1">
                ...
                <div className="grow pt-0.5 pb-8 sm:pb-12">
                  <p className="text-sm lg:text-base text-neutral-400 font-cairo">
                    <span className="text-black font-semibold">
                      {language === 'ar' ? 'أعلى معايير الأمان:' : 'Highest Safety Standards:'}
                    </span>
                    {" "}
                    {language === 'ar' 
              ...
              <div className="flex gap-x-5 ms-1">
                ...
                <div className="grow pt-0.5 pb-8 sm:pb-12">
                  <p className="text-sm md:text-base text-neutral-400 font-cairo">
                    <span className="text-black font-semibold">
                      {language === 'ar' ? 'الالتزام البيئي:' : 'Environmental Commitment:'}
                    </span>
                    {" "}
                    {language === 'ar' 
